...
export default function Agent3() {
  ...
  const isActive = activeAgentId === 3;
  const Icon = icons[3 as keyof typeof icons] || Code;
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 text-center">
        <h3 className="text-sm font-bold text-white">Ciro</h3>
        <p className="text-xs text-slate-400">Backend Dev</p>
      </div>
      {isActive && (
