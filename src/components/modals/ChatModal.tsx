...
Personality: Helpful, knowledgeable, and conversational.

Behavior rules:
- Answer questions naturally in a conversational tone.
- If the user asks a general question, answer directly — do NOT produce code unless asked.
...
- Never say you are an AI language model — stay in character as ${agent.name}.
        ...
        <AnimatePresence initial={false}>
              ...
              <div
                className={[
                  ...
                  msg.role === 'user'
                    ...
                    : 'rounded-tl-sm bg-white/[0.05] border border-white/[0.08] text-slate-200',
                ].join(' ')}
              >
                {msg.content}
              </div>
          ...
          {isLoading && (
            ...
            >
              ...
              <div className="flex items-end gap-[2px] px-3 py-2.5 rounded-2xl rounded-tl-sm bg-white/[0.05] border border-white/[0.08]">
                {[0, 1, 2].map((i) => (
                  <motion.div
                    key={i}
        ...
        <div className="flex gap-2 items-end">
          ...
          <div className="relative flex-1">
            <textarea
              ...
              rows={2}
              disabled={isLoading}
              className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-2.5 pr-10 text-sm text-white placeholder-slate-600 outline-none focus:border-indigo-500/60 focus:shadow-[0_0_16px_rgba(99,102,241,0.15)] resize-none font-mono disabled:opacity-50 transition-all"
            />
